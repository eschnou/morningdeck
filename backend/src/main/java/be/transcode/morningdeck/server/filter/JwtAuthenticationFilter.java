...
import be.transcode.morningdeck.server.core.service.JwtService;
        ...
        try {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                try {
                    ...
                    log.warn("Disabled user attempted to authenticate: {}", username);
                    sendErrorResponse(response, HttpStatus.FORBIDDEN, "Account is disabled");
                    return;
                }
