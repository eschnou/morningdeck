...
<head>
    ...
    <title>Verify Your Email - Morning Deck</title>
    <style type="text/css">
        ...
        .notice { background: #f7f6f3; border: 1px solid #e9e7e4; border-radius: 6px; padding: 14px 16px; margin: 24px 0; font-size: 13px; color: #6b6a67; }
        .footer { font-size: 13px; line-height: 1.6; color: #9b9a97; margin-top: 24px; }
...
<div class="container">
    ...
    <div class="body-text">
        Hello ${fullName},
        <br><br>
        Thank you for registering with Morning Deck. Please click the button below to verify your email address.
    </div>
    ...
    <div class="footer">
        ...
        <br><br>
        Questions? Contact us at <a href="mailto:support@transcode.be">support@transcode.be</a>
    </div>
</div>
</body>
</html>
